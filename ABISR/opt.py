...
opt["diffusion_sr_path"] = "datasets/diffusion_sr"                # The cropped GT images
...
opt['checkpoints_freq'] = 10             # frequency to store checkpoints in the folder (unit: epoch)  !pre50!
...
if opt['architecture'] == "GRL":             # L1 loss training version
    ...
    opt['train_iterations'] = 300000         # Training Iterations !pre300000!
    ...
    opt['decay_iteration'] = 100000          # Decay iteration  !pre100000!
